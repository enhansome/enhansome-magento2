...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 501,445 | 🐛 105 | 📅 2026-08-21
...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 501,445 | 🐛 105 | 📅 2026-08-21
...
* [MageObsidian](https://github.com/mage-obsidian/module-modern-frontend) ⭐ 4 | 🐛 0 | 🌐 PHP | 📅 2026-08-30 🫡 - Open-source Luma replacement using Vite, Vue 3 islands and TailwindCSS 4 on top of native layouts/blocks/templates. Native ESM, HMR, optional Twig engine.
...
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,820 | 🐛 159 | 🌐 Go | 📅 2026-08-30 🔥 🫡 - Open source tool for launching local web development environments in minutes. Supports PHP, Node.js and Python.
...
* [n98-magerun2](https://github.com/netz98/n98-magerun2) ⭐ 926 | 🐛 15 | 🌐 PHP | 📅 2026-08-29 🫡 - The CLI Swiss Army Knife for Magento 2.
...
* [PhpStorm Magento2 Extension](https://github.com/magento/magento2-phpstorm-plugin) ⭐ 463 | 🐛 66 | 🌐 Java | 📅 2026-08-28 🫡 - Official PhpStorm Magento 2 extension.
...
* [Magewire PHP](https://github.com/magewirephp/magewire) ⭐ 262 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-28 🫡 - A Laravel Livewire port for building complex AJAX-based components with ease. Used by the Hyvä Checkout.
...
* [Yireo LokiComponents](https://github.com/yireo/Yireo_LokiComponents) ⭐ 10 | 🐛 0 | 🌐 PHP | 📅 2026-08-28 🫡 - A library for building AJAX-driven form components with ease. Used by the Yireo Loki Checkout.
...
* [Deployer Magento2 Recipe](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php) ⭐ 11,101 | 🐛 18 | 🌐 PHP | 📅 2026-08-26 🫡 - Magento 2 deployment recipe for deployer.
...
* [Elastic Suite Integration](https://github.com/Smile-SA/elasticsuite/) ⭐ 802 | 🐛 129 | 🌐 PHP | 📅 2026-08-28 🔥 🫡 - Elastic Suite Integration.
* [Algolia Search Integration](https://github.com/algolia/algoliasearch-magento-2) ⭐ 191 | 🐛 2 | 🌐 PHP | 📅 2026-08-28 🫡 - Algolia Search (SaaS) Integration.
...
* [Opengento GDPR](https://github.com/opengento/magento2-gdpr) ⭐ 146 | 🐛 8 | 🌐 PHP | 📅 2025-07-23 - Magento 2 GDPR module to help be GDPR compliant.
...
* [hyva-ai-tools](https://github.com/hyva-themes/hyva-ai-tools) ⭐ 82 | 🐛 4 | 🌐 Shell | 📅 2026-07-31 - AI-powered skills for Magento 2 development with Hyva Theme. These skills extend AI coding assistants with specialized knowledge for creating Hyva themes, modules, and CMS components.
...
* [module-blog](https://github.com/mage-os-lab/module-blog) ⭐ 22 | 🐛 1 | 🌐 PHP | 📅 2026-08-28 🫡 - Blog module for Mage-OS / Magento 2 with posts, categories, tags, authors, scheduled publishing, SEO, RSS, sitemap, 6 widgets, and a full GraphQL API. Luma + Hyvä.
...
* [Menu Editor](https://github.com/SnowdogApps/magento2-menu) ⭐ 332 | 🐛 29 | 🌐 JavaScript | 📅 2026-08-19 🔥 🫡 - Provides a powerful menu editor to replace category-based menus in Magento 2.
...
* [PageNotFound](https://github.com/experius/Magento-2-Module-PageNotFound) ⭐ 45 | 🐛 14 | 🌐 PHP | 📅 2026-08-26 🫡 - Saves upcoming 404s in your database with the possibility to create a redirect.
...
* [Magento GitHub Repository](https://github.com/magento/magento2) ⭐ 12,170 | 🐛 2,145 | 🌐 PHP | 📅 2026-08-28 🫡 - Magento 2 GitHub repository.
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,675 | 🐛 85 | 📅 2026-07-13 - A curated list of awesome PHP resources.
