...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,010 | 🐛 106 | 📅 2026-09-02
...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 503,010 | 🐛 106 | 📅 2026-09-02
...
* [MageObsidian](https://github.com/mage-obsidian/module-modern-frontend) ⭐ 4 | 🐛 0 | 🌐 PHP | 📅 2026-09-02 🫡 - Open-source Luma replacement using Vite, Vue 3 islands and TailwindCSS 4 on top of native layouts/blocks/templates. Native ESM, HMR, optional Twig engine.
...
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,831 | 🐛 167 | 🌐 Go | 📅 2026-09-04 🔥 🫡 - Open source tool for launching local web development environments in minutes. Supports PHP, Node.js and Python.
...
* [n98-magerun2](https://github.com/netz98/n98-magerun2) ⭐ 925 | 🐛 22 | 🌐 PHP | 📅 2026-09-03 🫡 - The CLI Swiss Army Knife for Magento 2.
* [Warden](https://github.com/wardenenv/warden) ⭐ 467 | 🐛 47 | 🌐 Shell | 📅 2026-08-10 🫡 - CLI utility for working with docker-compose environments by David Alger.
...
* [Mage](https://github.com/GrimLink/mage) ⭐ 25 | 🐛 5 | 🌐 Shell | 📅 2026-08-03 🫡 - Simplifies bin/magento commands with shortcuts and productivity helpers.
* [MageForge](https://github.com/OpenForgeProject/mageforge) ⭐ 21 | 🐛 2 | 🌐 PHP | 📅 2026-09-03 🫡 - Magento 2 CLI automatic theme builder (Hyvä ready).
...
* [Magewire PHP](https://github.com/magewirephp/magewire) ⭐ 262 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-01 🫡 - A Laravel Livewire port for building complex AJAX-based components with ease. Used by the Hyvä Checkout.
...
* [Auto Cache Flush](https://github.com/yireo/Yireo_AutoFlushCache) ⭐ 28 | 🐛 1 | 🌐 PHP | 📅 2026-09-03 - Magento 2 module to automatically flush the cache.
...
* [Yireo LokiComponents](https://github.com/yireo/Yireo_LokiComponents) ⭐ 10 | 🐛 0 | 🌐 PHP | 📅 2026-09-04 🫡 - A library for building AJAX-driven form components with ease. Used by the Yireo Loki Checkout.
...
* [Github Actions for Magento2](https://github.com/extdn/github-actions-m2) ⭐ 142 | 🐛 19 | 🌐 Shell | 📅 2026-09-03 - GitHub Actions for Magento 2 Extensions.
...
* [Elastic Suite Integration](https://github.com/Smile-SA/elasticsuite/) ⭐ 802 | 🐛 131 | 🌐 PHP | 📅 2026-09-03 🔥 🫡 - Elastic Suite Integration.
...
* [hyva-ai-tools](https://github.com/hyva-themes/hyva-ai-tools) ⭐ 83 | 🐛 4 | 🌐 Shell | 📅 2026-07-31 - AI-powered skills for Magento 2 development with Hyva Theme. These skills extend AI coding assistants with specialized knowledge for creating Hyva themes, modules, and CMS components.
...
* [magento2-hyva-admin](https://github.com/hyva-themes/magento2-hyva-admin) ⭐ 176 | 🐛 34 | 🌐 CSS | 📅 2026-06-26 🫡 - This module aims to make creating grids and forms in the Magento 2 adminhtml area joyful and fast.
...
* [Magento 2 Import Framework](https://github.com/techdivision/import) ⭐ 128 | 🐛 12 | 🌐 PHP | 📅 2026-09-03 - A library supporting generic Magento 2 import functionality.
* [Checkout Tester](https://github.com/yireo/Yireo_CheckoutTester2) ⭐ 93 | 🐛 3 | 🌐 PHP | 📅 2026-09-03 - Extension to quickly test Checkout changes.
...
* [Magento GitHub Repository](https://github.com/magento/magento2) ⭐ 12,178 | 🐛 2,168 | 🌐 PHP | 📅 2026-09-04 🫡 - Magento 2 GitHub repository.
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,677 | 🐛 85 | 📅 2026-07-13 - A curated list of awesome PHP resources.
