...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 504,265 | 🐛 106 | 📅 2026-09-02
...
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,833 | 🐛 169 | 🌐 Go | 📅 2026-09-08 🔥 🫡 - Open source tool for launching local web development environments in minutes. Supports PHP, Node.js and Python.
...
* [n98-magerun2](https://github.com/netz98/n98-magerun2) ⭐ 925 | 🐛 19 | 🌐 PHP | 📅 2026-09-08 🫡 - The CLI Swiss Army Knife for Magento 2.
...
* [Magewire PHP](https://github.com/magewirephp/magewire) ⭐ 262 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-08 🫡 - A Laravel Livewire port for building complex AJAX-based components with ease. Used by the Hyvä Checkout.
...
* [magento2-withdrawl](https://github.com/Zwernemann/magento2-withdrawl) ⭐ 26 | 🐛 6 | 🌐 PHP | 📅 2026-09-08 🫡 - Magento 2 module providing a compliant EU withdrawal button required from June 19, 2026 (§356a BGB / Directive (EU) 2023/2673). Enables customers and guests to revoke orders via a simple form (name, order number, email), sends automatic confirmation emails, and allows admin management in the backend.
...
* [Magento GitHub Repository](https://github.com/magento/magento2) ⭐ 12,181 | 🐛 2,178 | 🌐 PHP | 📅 2026-09-08 🫡 - Magento 2 GitHub repository.
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,681 | 🐛 88 | 📅 2026-07-13 - A curated list of awesome PHP resources.
