...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 500,364 | 🐛 105 | 📅 2026-08-21
...
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,746 | 🐛 164 | 🌐 Go | 📅 2026-08-27 🔥 🫡 - Open source tool for launching local web development environments in minutes. Supports PHP, Node.js and Python.
...
* [Magewire PHP](https://github.com/magewirephp/magewire) ⭐ 262 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-27 🫡 - A Laravel Livewire port for building complex AJAX-based components with ease. Used by the Hyvä Checkout.
...
* [Deployer Magento2 Recipe](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php) ⭐ 11,098 | 🐛 18 | 🌐 PHP | 📅 2026-08-26 🫡 - Magento 2 deployment recipe for deployer.
...
* [Algolia Search Integration](https://github.com/algolia/algoliasearch-magento-2) ⭐ 191 | 🐛 3 | 🌐 PHP | 📅 2026-08-27 🫡 - Algolia Search (SaaS) Integration.
...
* [Menu Editor](https://github.com/SnowdogApps/magento2-menu) ⭐ 332 | 🐛 28 | 🌐 JavaScript | 📅 2026-08-19 🔥 🫡 - Provides a powerful menu editor to replace category-based menus in Magento 2.
...
* [Magento GitHub Repository](https://github.com/magento/magento2) ⭐ 12,169 | 🐛 2,129 | 🌐 PHP | 📅 2026-08-27 🫡 - Magento 2 GitHub repository.
