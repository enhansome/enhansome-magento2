...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 499,903 | 🐛 106 | 📅 2026-08-21
...
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,745 | 🐛 157 | 🌐 Go | 📅 2026-08-25 🔥 🫡 - Open source tool for launching local web development environments in minutes. Supports PHP, Node.js and Python.
...
* [n98-magerun2](https://github.com/netz98/n98-magerun2) ⭐ 926 | 🐛 17 | 🌐 PHP | 📅 2026-08-25 🫡 - The CLI Swiss Army Knife for Magento 2.
...
* [Magewire PHP](https://github.com/magewirephp/magewire) ⭐ 262 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-25 🫡 - A Laravel Livewire port for building complex AJAX-based components with ease. Used by the Hyvä Checkout.
* [MageVulnDB](https://github.com/gwillem/magevulndb) ⭐ 220 | 🐛 11 | 🌐 PHP | 📅 2026-08-25 - Central repository for third-party Magento extensions with known security issues.
...
* [Elastic Suite Integration](https://github.com/Smile-SA/elasticsuite/) ⭐ 803 | 🐛 129 | 🌐 PHP | 📅 2026-08-20 🔥 🫡 - Elastic Suite Integration.
* [Algolia Search Integration](https://github.com/algolia/algoliasearch-magento-2) ⭐ 190 | 🐛 4 | 🌐 PHP | 📅 2026-08-25 🫡 - Algolia Search (SaaS) Integration.
...
* [Google Tag Manager](https://github.com/magepal/magento2-google-tag-manager) ⭐ 265 | 🐛 16 | 🌐 PHP | 📅 2026-05-15 🔥 - Google Tag Manager (GTM) with Data Layer for Magento 2.
...
* [module-blog](https://github.com/mage-os-lab/module-blog) ⭐ 17 | 🐛 1 | 🌐 PHP | 📅 2026-08-25 🫡 - Blog module for Mage-OS / Magento 2 with posts, categories, tags, authors, scheduled publishing, SEO, RSS, sitemap, 6 widgets, and a full GraphQL API. Luma + Hyvä.
...
* [Magento GitHub Repository](https://github.com/magento/magento2) ⭐ 12,169 | 🐛 2,128 | 🌐 PHP | 📅 2026-08-25 🫡 - Magento 2 GitHub repository.
